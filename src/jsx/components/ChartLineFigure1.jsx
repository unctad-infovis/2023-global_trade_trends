      ...
      chart: {
        events: {
          load() {
            ...
            this.renderer.image(`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-global_trade_trends/' : './'}assets/img/unctad_logo.svg`, 20, 15, 80, 100).add();
            // setTimeout(() => {
            //   // eslint-disable-next-line react/no-this-in-sfc
